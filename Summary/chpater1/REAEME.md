...
sol)
- 쿼리 행렬과 키 행렬간의 내적을 계산하고 유사도를 구한다.
- Q \cdot
3. 스케일 닷 프로덕트 어텐션을 정의하라.
4. 쿼리, 키, 밸류 행렬은 어떻게 생성하는가?
5. 위치 인코딩이 필요한 이유는 무엇인가?
6. 디코더의 서브레이어에는 무엇이 있는가?
7. 디코더의 인코더-디코더 어텐션 레이어의 입력은 무엇인가?
